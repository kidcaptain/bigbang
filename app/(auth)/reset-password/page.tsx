          ...
          <div className="max-w-sm mx-auto">
            <form>
              ...
              <div className="flex flex-wrap mt-6 -mx-3">
                <div className="w-full px-3">
                  <button className="w-full text-white bg-black btn hover:bg-stone-700">Reset Password</button>
                </div>
              </div>
            </form>
            <div className="mt-6 text-center text-gray-400">
              <Link href="/signin" className="text-red-600 transition duration-150 ease-in-out hover:text-gray-200">Cancel</Link>
            </div>
          </div>
